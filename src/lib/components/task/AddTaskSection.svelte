<script>
	import { addTask, tasks } from '../../store/TaskStore';
...
<section class="flex justify-between">
	...
	<button
		class="group flex items-center rounded-md bg-green-one px-6 py-3 text-lg font-semibold text-gray-five outline outline-2 outline-offset-2 outline-green-one hover:bg-green-two hover:text-green-five focus-visible:text-green-five focus-visible:outline-green-five"
		type="button"
		on:click={addTask}
	>
		Add Task
